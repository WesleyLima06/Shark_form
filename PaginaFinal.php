...
<body class="main">
   ...
   <h1 class="text">Seu fardamento será enviado após 3 dias úteis.</h1>
   <p class="paragrafo"> Você receberá mais informações via e-mail, obrigado :)</p>
    <div class="container">
        <div>
            <a href="home.php" class="left-button">Home</a> 
        </div class="right">
        <div>
